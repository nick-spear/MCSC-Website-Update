$(document).ready(function() {
	...
	$('.resources-accordion-content').hide();

	$('.resources-accordion-wrapper h2').on('click', function() {
		if (!$(this).hasClass('accordion-open')) {  // open
			$(this).next('.resources-accordion-content').slideDown(200, 'linear');
